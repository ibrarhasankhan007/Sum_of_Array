...
HD_PWD='C:/Users/Ibrar/OneDrive/Desktop/vivado/add_ip/add_ip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_ip.tcl
